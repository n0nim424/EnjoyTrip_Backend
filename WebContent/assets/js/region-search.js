...
function showDescription(data){
	return function(){
		...
		let detailUrl = "/enjoytrip_backend_S15_team/region?action=get-description&content_id=" + data.contentId;
		fetch(detailUrl)
			.then((response) => response.json())
			.then((description) => {
			    ...
			    let content = `<div class="m1" style="width: 100%;">
				    				...
				    				<div style="margin: 10px;>
				        				...
				        				<br/>
				        				<span style="font-size: 18pt;">주소 : ${data.addr1}</span> <span>${data.addr2}</span>
				        				<br/>
